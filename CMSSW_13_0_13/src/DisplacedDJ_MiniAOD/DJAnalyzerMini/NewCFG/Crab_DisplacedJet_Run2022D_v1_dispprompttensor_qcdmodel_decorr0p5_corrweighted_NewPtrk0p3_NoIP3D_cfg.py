...
config.General.requestName = 'data_DisplacedJet2022D_v1_Run3_dispprompt_qcd_noIP3D_0p3_power2'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName =  'Anl_base_Data2022_IVFlike_Disp_tensornew_dispprompt_NewPtrk_QCD_300_decorr1p0_corrweighted_power3_cfg.py'
...
config.Data.outputDatasetTag = 'data_DisplacedJet2022D_v1_Run3_dispprompt_qcd_noIP3D_0p3_power2'
