...
process.GlobalTag.globaltag =  cms.string("124X_mcRun3_2022_realistic_v12")#autoCond["run2_mc"]#cms.string("94X_mc2017_realistic_v14")
...
process.TFileService.fileName = cms.string('output_0_ggH_NewPtrk_qcdmodel_PT300_decorr0p5_power2_corrweighted_PTRK0p3_noIP3D.root')
