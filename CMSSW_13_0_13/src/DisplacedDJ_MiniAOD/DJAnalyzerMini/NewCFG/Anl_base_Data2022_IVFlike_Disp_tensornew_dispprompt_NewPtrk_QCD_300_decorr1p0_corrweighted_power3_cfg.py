...
process.GlobalTag.globaltag =  cms.string("124X_dataRun3_PromptAnalysis_v1")#autoCond["run2_mc"]#cms.string("94X_mc2017_realistic_v14")
...
process.myAnalyzerLabel = cms.EDAnalyzer('DijetIVFMiniMLDisp_NewPtrk_dispprompttensor', #DijetIVFMiniDefault.clone(
     ...
     #, promptgraph_path=cms.FileInPath("DisplacedDJ_MiniAOD/DJAnalyzerMini/data/PromptOnlyNewPtrk_Run3_qcd_PT300_decorr1p0_distcorr.pb")
     #, promptgraph_path=cms.FileInPath("DisplacedDJ_MiniAOD/DJAnalyzerMini/data/PromptOnlyNewPtrk_best_Run3_qcd_PT300_decorr1p0_corrweighted_power3.pb")
...
#process.source = cms.Source('PoolSource', fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/data/Run2022D/DisplacedJet/MINIAOD/PromptReco-v2/000/357/734/00000/22ed8422-dd55-4b2e-9af8-1f35c5220f04.root'))
process.source = cms.Source('PoolSource', fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/data/Run2022F/DisplacedJet/MINIAOD/PromptReco-v1/000/360/393/00000/d50b86f4-ae1a-4edc-96cb-fdd27673dfb4.root'))
...
process.TFileService.fileName = cms.string('output_0_data_one_merge_qcd_random_NewPtrk_decorr0p5_power2_corrweighted_PTRK0p3_noIP3D_slim.root')
