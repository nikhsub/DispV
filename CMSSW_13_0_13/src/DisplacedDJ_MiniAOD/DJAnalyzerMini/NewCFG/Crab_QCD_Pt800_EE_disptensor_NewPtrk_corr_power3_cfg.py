...
config.General.requestName = 'QCD_Pt800_EE_EDAN_Run3_dispprompt_NewPtrk_fullmodel_Mar25'
...
config.Data.outputDatasetTag = 'QCD_Pt800_EE_Run3_dispprompt_NewPtrk_fullmodel_Mar25'
