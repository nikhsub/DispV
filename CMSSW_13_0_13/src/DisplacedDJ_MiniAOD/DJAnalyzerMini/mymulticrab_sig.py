...
def sub_crab_job(mass, life):
    ...
    datasetname = getstatusoutput("das_client --query='dataset=/ggH_Hto2Sto4B_MH-125-MS-"+str(mass)+"-ctauS-"+str(life)+"_PTH-80_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2/MINIAODSIM*'")[1].split("\n")[0]
    config.General.requestName = 'MC_sig_ggH_HSS_MS-'+str(mass)+'-ctauS-'+str(life)+'_1801_mytaggers'
    ...
    config.Data.outputDatasetTag = 'MC_sig_ggH_HSS_MS-'+str(mass)+'-ctauS-'+str(life)+'_1801_mytaggers'
