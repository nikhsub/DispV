...
process.myAnalyzerLabel = cms.EDAnalyzer('DijetIVFMiniMLDisp_NewPtrk_dispprompttensor', #DijetIVFMiniDefault.clone(
     ...
     , promptgraph_path=cms.FileInPath("DisplacedDJ_MiniAOD/DJAnalyzerMini/data/PromptOnlyNewPtrk_test.pb") 
...
process.TFileService.fileName = cms.string('output_0_ggH_NewPtrk_test.root')
