...
config.General.requestName = 'MC_Run3_2022_realistic_newDispGraph_1001'
...
config.Data.inputDataset = '/ggH_Hto2Sto4B_MH-125-MS-40-ctauS-10_PTH-80_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2/MINIAODSIM' 
...
config.Data.outputDatasetTag = 'test_1001_myDispTagger'
