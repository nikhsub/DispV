...
class DijetIVFMiniMLDisp_NewPtrk_dispprompttensor : public edm::one::EDAnalyzer<edm::one::WatchLuminosityBlocks,
                                                                 edm::one::SharedResources>  { 
   public:
  
      explicit DijetIVFMiniMLDisp_NewPtrk_dispprompttensor(const edm::ParameterSet&);
      ~DijetIVFMiniMLDisp_NewPtrk_dispprompttensor();
   ...
   private:
      ...
      std::vector<float> SVjet1maxPVPt;
      std::vector<float> SVjet2maxPVPt; 
