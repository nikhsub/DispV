...
process.GlobalTag.globaltag =  cms.string("124X_mcRun3_2022_realistic_postEE_v1")#autoCond["run2_mc"]#cms.string("94X_mc2017_realistic_v14")
...
process.myAnalyzerLabel = cms.EDAnalyzer('DijetIVFMiniMLDisp_NewPtrk_dispprompttensor', #DijetIVFMiniDefault.clone(
     ...
     , jetCorr = cms.untracked.InputTag('ak4CaloL1FastL2L3Corrector') 
     ...
     ,dispgraph_path=cms.FileInPath("DisplacedDJ_MiniAOD/DJAnalyzerMini/data/DispGraph_1001.pb")
     #, dispgraph_path=cms.FileInPath("DisplacedDJ_MiniAOD/DJAnalyzerMini/data/DispOnly_best_Run3_QCD_random.pb")
     #, promptgraph_path=cms.FileInPath("DisplacedDJ_MiniAOD/DJAnalyzerMini/data/PromptOnlyNewPtrk_Run3_qcd_PT300_decorr0p5_corrweighted_noIP3D_0p3_power2.pb")
     , promptgraph_path=cms.FileInPath("DisplacedDJ_MiniAOD/DJAnalyzerMini/data/PromptOnly_testgraph_2711.pb")
...
#process.source = cms.Source('PoolSource', fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/mc/RunIIAutumn18MiniAOD/ggH_HToSSTobbbb_MH-125_MS-40_ctauS-10_pT75_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v1/270000/105753CE-B21A-824B-990B-B2C15F926F36.root'))
...
process.source = cms.Source('PoolSource', fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/lpcbril/MC_test/ggH4b_MINIAODSIM_Run3/HToLL_Run3/HToLLTo4b_Powheg_postEE_M40_10mm_CP5_13p6TeV_HPt100_MINIAODSIM_ext/230216_143116/0000/step0_966.root'))
#process.source = cms.Source('PoolSource', fileNames = cms.untracked.vstring('file:/uscms_data/d3/jluo/work/CMSSW_dir/DJRun3/Simulation/NEW/CMSSW_12_4_11_patch3/src/step0.root'))
#process.source = cms.Source('PoolSource', fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/mc/Run3Summer22MiniAODv3/QCD_PT-470to600_TuneCP5_13p6TeV_pythia8/MINIAODSIM/124X_mcRun3_2022_realistic_v12-v2/80000/137c482a-ddf0-4917-b8b8-8377679a0365.root'))
...
#process.TFileService.fileName = cms.string('output_0_ggH_one_merge_tt_random_best_dispprompt.root')$process.TFileService.fileName = cms.string('output_0_ggH_test.root')
process.TFileService.fileName = cms.string('output_0_postEE_ggH_NewPtrk0p3_qcdmodel_PT300_decorr0p5_corrweighted_power2.root')
