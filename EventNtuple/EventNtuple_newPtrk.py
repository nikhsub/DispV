...
parser.add_argument("-r", "--random", default=False, action="store_true", help="randomly select dijet candidate")
...
h_ntrk = ROOT.TH1F("h_ntrk", "h_ntrk", 20, 0, 20)
h_ntrk.Sumw2()
...
HLT_HT430_DisplacedDijet40_DisplacedTrack_v = array.array('I', [0])
HLT_HT430_DisplacedDijet30_Inclusive1PtrkShortSig5_v                    = array.array('I', [0])
HLT_HT430_DisplacedDijet35_Inclusive1PtrkShortSig5_v                    = array.array('I', [0])
HLT_HT430_DisplacedDijet40_Inclusive1PtrkShortSig5_v                    = array.array('I', [0])
HLT_Mu6HT240_DisplacedDijet30_Inclusive0PtrkShortSig5_v                 = array.array('I', [0])
HLT_Mu6HT240_DisplacedDijet30_Inclusive1PtrkShortSig5_DisplacedLoose_v  = array.array('I', [0])
HLT_Mu6HT240_DisplacedDijet35_Inlcusive0PtrkShortSig5_v                 = array.array('I', [0])
HLT_Mu6HT240_DisplacedDijet35_Inclusive1PtrkShortSig5_DisplacedLoose_v  = array.array('I', [0])
HLT_Mu6HT240_DisplacedDijet40_Inclusive0PtrkShortSig5_v                 = array.array('I', [0])
HLT_Mu6HT240_DisplacedDijet40_Inclusive1PtrkShortSig5_DisplacedLoose_v  = array.array('I', [0])
...
ptrkIP2D = array.array('d', max_Nptrk*[0])
ptrkIP2Dsig = array.array('d', max_Nptrk*[0])
ptrkIP3D = array.array('d', max_Nptrk*[0])
ptrkIP3Dsig = array.array('d', max_Nptrk*[0])
ptrkEFrac = array.array('d', max_Nptrk*[0])
ptrkIP3Dminsig = array.array('d', max_Nptrk*[0])
ptrkdR = array.array('d', max_Nptrk*[0])
ptrkPVidx = array.array('i', max_Nptrk*[0])
ptrkjet1 = array.array('I', max_Nptrk*[0])
ptrkjet2 = array.array('I', max_Nptrk*[0])
ptrkPVassoc = array.array('I', max_Nptrk*[0])
ptrkPUassoc = array.array('I', max_Nptrk*[0])
...
#jet2_ptrkdR = array.array('d', max_Nptrk*[0])
...
newtree.Branch("ptrkIP2D" ,      ptrkIP2D,       "ptrkIP2D[nptrk_size]/D")
newtree.Branch("ptrkIP2Dsig",    ptrkIP2Dsig,    "ptrkIP2Dsig[nptrk_size]/D")
newtree.Branch("ptrkIP3D",       ptrkIP3D,       "ptrkIP3D[nptrk_size]/D")
newtree.Branch("ptrkIP3Dsig",    ptrkIP3Dsig,    "ptrkIP3Dsig[nptrk_size]/D")
newtree.Branch("ptrkEFrac",      ptrkEFrac,      "ptrkEFrac[nptrk_size]/D")
newtree.Branch("ptrkIP3Dminsig", ptrkIP3Dminsig, "ptrkIP3Dminsig[nptrk_size]/D")
newtree.Branch("ptrkdR",         ptrkdR,         "ptrkdR[nptrk_size]/D")
newtree.Branch("ptrkPVidx",      ptrkPVidx,      "ptrkPVidx[nptrk_size]/I")
newtree.Branch("ptrkjet1",       ptrkjet1,       "ptrkjet1[nptrk_size]/i")
newtree.Branch("ptrkjet2",       ptrkjet2,       "ptrkjet2[nptrk_size]/i")
newtree.Branch("ptrkPVassoc",    ptrkPVassoc,    "ptrkPVassoc[nptrk_size]/i")
newtree.Branch("ptrkPUassoc",    ptrkPVassoc,    "ptrkPUassoc[nptrk_size]/i")
...
#newtree.Branch("jet2_ptrkdR", jet2_ptrkdR, "jet2_ptrkdR[nptrk_size]/D")
...
newtree.Branch("HLT_HT430_DisplacedDijet40_DisplacedTrack_v", HLT_HT430_DisplacedDijet40_DisplacedTrack_v, "HLT_HT430_DisplacedDijet40_DisplacedTrack_v/i")

newtree.Branch("HLT_HT430_DisplacedDijet30_Inclusive1PtrkShortSig5_v"                   , HLT_HT430_DisplacedDijet30_Inclusive1PtrkShortSig5_v,                   "HLT_HT430_DisplacedDijet30_Inclusive1PtrkShortSig5_v/i")                    
newtree.Branch("HLT_HT430_DisplacedDijet35_Inclusive1PtrkShortSig5_v"                   , HLT_HT430_DisplacedDijet35_Inclusive1PtrkShortSig5_v,                   "HLT_HT430_DisplacedDijet35_Inclusive1PtrkShortSig5_v/i")                   
newtree.Branch("HLT_HT430_DisplacedDijet40_Inclusive1PtrkShortSig5_v"                   , HLT_HT430_DisplacedDijet40_Inclusive1PtrkShortSig5_v,                   "HLT_HT430_DisplacedDijet40_Inclusive1PtrkShortSig5_v/i")                   
newtree.Branch("HLT_Mu6HT240_DisplacedDijet30_Inclusive0PtrkShortSig5_v"                , HLT_Mu6HT240_DisplacedDijet30_Inclusive0PtrkShortSig5_v,                "HLT_Mu6HT240_DisplacedDijet30_Inclusive0PtrkShortSig5_v/i")                
newtree.Branch("HLT_Mu6HT240_DisplacedDijet30_Inclusive1PtrkShortSig5_DisplacedLoose_v" , HLT_Mu6HT240_DisplacedDijet30_Inclusive1PtrkShortSig5_DisplacedLoose_v, "HLT_Mu6HT240_DisplacedDijet30_Inclusive1PtrkShortSig5_DisplacedLoose_v/i") 
newtree.Branch("HLT_Mu6HT240_DisplacedDijet35_Inlcusive0PtrkShortSig5_v"                , HLT_Mu6HT240_DisplacedDijet35_Inlcusive0PtrkShortSig5_v,                "HLT_Mu6HT240_DisplacedDijet35_Inlcusive0PtrkShortSig5_v/i")                
newtree.Branch("HLT_Mu6HT240_DisplacedDijet35_Inclusive1PtrkShortSig5_DisplacedLoose_v" , HLT_Mu6HT240_DisplacedDijet35_Inclusive1PtrkShortSig5_DisplacedLoose_v, "HLT_Mu6HT240_DisplacedDijet35_Inclusive1PtrkShortSig5_DisplacedLoose_v/i") 
newtree.Branch("HLT_Mu6HT240_DisplacedDijet40_Inclusive0PtrkShortSig5_v"                , HLT_Mu6HT240_DisplacedDijet40_Inclusive0PtrkShortSig5_v,                "HLT_Mu6HT240_DisplacedDijet40_Inclusive0PtrkShortSig5_v/i")                
newtree.Branch("HLT_Mu6HT240_DisplacedDijet40_Inclusive1PtrkShortSig5_DisplacedLoose_v" , HLT_Mu6HT240_DisplacedDijet40_Inclusive1PtrkShortSig5_DisplacedLoose_v, "HLT_Mu6HT240_DisplacedDijet40_Inclusive1PtrkShortSig5_DisplacedLoose_v/i") 
...
tree.SetBranchAddress("HLT_HT430_DisplacedDijet40_DisplacedTrack_v", HLT_HT430_DisplacedDijet40_DisplacedTrack_v)
tree.SetBranchAddress("HLT_HT430_DisplacedDijet30_Inclusive1PtrkShortSig5_v",                   HLT_HT430_DisplacedDijet30_Inclusive1PtrkShortSig5_v)                   
tree.SetBranchAddress("HLT_HT430_DisplacedDijet35_Inclusive1PtrkShortSig5_v",                   HLT_HT430_DisplacedDijet35_Inclusive1PtrkShortSig5_v)                   
tree.SetBranchAddress("HLT_HT430_DisplacedDijet40_Inclusive1PtrkShortSig5_v",                   HLT_HT430_DisplacedDijet40_Inclusive1PtrkShortSig5_v)                   
tree.SetBranchAddress("HLT_Mu6HT240_DisplacedDijet30_Inclusive0PtrkShortSig5_v",                HLT_Mu6HT240_DisplacedDijet30_Inclusive0PtrkShortSig5_v)                
tree.SetBranchAddress("HLT_Mu6HT240_DisplacedDijet30_Inclusive1PtrkShortSig5_DisplacedLoose_v", HLT_Mu6HT240_DisplacedDijet30_Inclusive1PtrkShortSig5_DisplacedLoose_v) 
tree.SetBranchAddress("HLT_Mu6HT240_DisplacedDijet35_Inlcusive0PtrkShortSig5_v",                HLT_Mu6HT240_DisplacedDijet35_Inlcusive0PtrkShortSig5_v)                
tree.SetBranchAddress("HLT_Mu6HT240_DisplacedDijet35_Inclusive1PtrkShortSig5_DisplacedLoose_v", HLT_Mu6HT240_DisplacedDijet35_Inclusive1PtrkShortSig5_DisplacedLoose_v) 
tree.SetBranchAddress("HLT_Mu6HT240_DisplacedDijet40_Inclusive0PtrkShortSig5_v",                HLT_Mu6HT240_DisplacedDijet40_Inclusive0PtrkShortSig5_v)                
tree.SetBranchAddress("HLT_Mu6HT240_DisplacedDijet40_Inclusive1PtrkShortSig5_DisplacedLoose_v", HLT_Mu6HT240_DisplacedDijet40_Inclusive1PtrkShortSig5_DisplacedLoose_v) 
...
for iev in range(nentries):
    ...
    if best_idijet==-1:
        if not args.random:
            ...
            for idijet in range(Ndijet):
                ...
                #tmp_ntrk = 0
                #tmp_sumChi2 = 0
                tmp_SVDNNd = tree.SVDNNd.at(idijet)
                if tmp_SVDNNd>max_SVDNNd:
                    max_SVDNNd = tmp_SVDNNd
                    best_idijet = idijet  

                #tmp_trkEFracSum = float(tree.SVtrkenergysum.at(idijet))/(float(tree.jet1trackEnergy.at(idijet))+float(tree.jet2trackEnergy.at(idijet)))
                #if tmp_trkEFracSum>max_trkEFracSum:
                #    max_trkEFracSum = tmp_trkEFracSum
                #    best_idijet = idijet
            ...
            #if Ndijet>0:
            #    best_idijet = ran.Integer(Ndijet)
            max_random=0
            for idijet in range(Ndijet):
                if tree.SVjet1Pt.at(idijet)<pt_cut or tree.SVjet2Pt.at(idijet)<pt_cut or tree.SVnSV.at(idijet)==0:
                    continue
                tmp_random = ran.Uniform(0, 1)
                if tmp_random>max_random:
                    best_idijet = idijet
                    max_random = tmp_random
    ...
    if best_idijet!=-1:
        ...
        svtrkEFracSum[0] = float(tree.SVtrkenergysum.at(best_idijet))/float((tree.jet1trackEnergy.at(best_idijet)+tree.jet2trackEnergy.at(best_idijet)))
        SVDNNd[0] = float(tree.SVDNNd.at(best_idijet))
        ...
        promptIndices = list(tree.promptIndices.at(best_idijet))
        ...
        promptdRjet1   = list(tree.promptdRjet1.at(best_idijet))
        promptdRjet2   = list(tree.promptdRjet2.at(best_idijet))
        promptPVidx    = list(tree.promptPVidx.at(best_idijet))

        promptIndices.reverse()
        promptIP2D.reverse()
        ...
        promptdRjet1.reverse()
        promptdRjet2.reverse()
        promptPVidx.reverse()
   
        for iptrk in range(Nptrk[0]):
            if iptrk<max_Nptrk:
                ptrkIP2D[iptrk] = tanh(promptIP2D[iptrk]*10)-1
                ptrkIP2Dsig[iptrk] = tanh(promptIP2Dsig[iptrk]/10)-1
                ptrkIP3D[iptrk] = tanh(promptIP3D[iptrk]*10)-1
                ptrkIP3Dsig[iptrk] = tanh(promptIP3Dsig[iptrk]/10)-1
                ptrkEFrac[iptrk] = tanh(promptEnergy[iptrk]/(tree.SVjet1Pt.at(best_idijet)+tree.SVjet2Pt.at(best_idijet)))
                ptrkIP3Dminsig[iptrk] = tanh(promptIP3Dminsig[iptrk]/10)-1
                ptrkdR[iptrk] = promptdRjet1[iptrk]-0.6
                ptrkPVidx[iptrk] = promptPVidx[iptrk]

                if fabs(promptIP3Dsig[iptrk])<3.0:
                    ptrkPVassoc[iptrk]=1
                else:
                    ptrkPVassoc[iptrk]=0

                if fabs(promptIP3Dminsig[iptrk])<3.0:
                    ptrkPUassoc[iptrk]=1
                else:
                    ptrkPUassoc[iptrk]=0 
               
                if promptIndices[iptrk]==1:
                    ptrkjet1[iptrk]=1
                    ptrkjet2[iptrk]=0
                else:
                    ptrkjet1[iptrk]=0
            ...
            #if promptIndices[iptrk]==2 and jet2_iptrk<max_Nptrk:
            ...
            #    jet2_ptrkdR[jet2_iptrk] = promptdRjet2[iptrk]-0.6 
            #    jet2_iptrk+=1

        if iptrk<max_Nptrk:
            for i in range(iptrk, max_Nptrk):
                ptrkIP2D[i] = 0
                ptrkIP2Dsig[i] = 0
                ptrkIP3D[i] = 0
                ptrkIP3Dsig[i] = 0
        ...
        for itrk in range(max_Ntrks): 
            if itrk<Ntrk[0]:
                trkIP2D[itrk] = tanh(tree.dijetIP2D.at(best_idijet).at(itrk)/50)
                trkIP2Dsig[itrk] = tanh(tree.dijetIP2D_sig.at(best_idijet).at(itrk)/1000)
                trkIP3D[itrk] = tanh(tree.dijetIP3D.at(best_idijet).at(itrk)/50)
                trkIP3Dsig[itrk] = tanh(tree.dijetIP3D_sig.at(best_idijet).at(itrk)/2000)
                trkLxyExp[itrk] = tanh(tree.dijetLxyexp.at(best_idijet).at(itrk)/100)
                trkEFracDijet[itrk] = tanh(tree.dijetenergys.at(best_idijet).at(itrk)/(tree.jet1trackEnergy.at(best_idijet)+tree.jet2trackEnergy.at(best_idijet)))
                trkIP3Dminsig[itrk] = tanh(tree.dijetIP3D_minsig.at(best_idijet).at(itrk)/200)
                trkdRjet1[itrk]     = tree.dijetdRjet1.at(best_idijet).at(itrk)-0.6
                trkdRjet2[itrk]     = tree.dijetdRjet2.at(best_idijet).at(itrk)-0.6
                if tree.dijethasSV.at(best_idijet).at(itrk):
                    fabs_ip2dsig_hasSV.append(fabs(tree.dijetIP2D_sig.at(best_idijet).at(itrk)))
        ...
        if len(fabs_ip2dsig_hasSV)>=1:
            sv1stIP2Dsig[0] = fabs_ip2dsig_hasSV[0]
        else:
            sv1stIP2Dsig[0] = 0
   
        if len(fabs_ip2dsig_hasSV)>=2:
            sv2ndIP2Dsig[0] = fabs_ip2dsig_hasSV[1]
        else:
            sv2ndIP2Dsig[0] =0
        ...
        for ivtx in range(max_Nvtxs):
            if ivtx<Nvtx[0]:
                ...
                svmass[ivtx]   = tanh(tree.SVvtxP4.at(best_idijet).at(ivtx).M()/10)
                svpt[ivtx]     = tanh(tree.SVvtxP4.at(best_idijet).at(ivtx).Pt()/20)
                svlxy[ivtx]    = tanh(tree.SVvtxlxy.at(best_idijet).at(ivtx)/100)
                svlxysig[ivtx] = tanh(tree.SVvtxlxysig.at(best_idijet).at(ivtx)/1000)
                svtrkEFrac[ivtx] = tanh(tree.SVtrksEnergyFrac.at(best_idijet).at(ivtx))
                svkappa[ivtx] = tanh(tree.SVkappa.at(best_idijet).at(ivtx)/700)
                ...
                svntrk_efracjet1[ivtx] = tanh(tree.SVenergyfrac_jet1.at(best_idijet).at(ivtx))
                svntrk_efracjet2[ivtx] = tanh(tree.SVenergyfrac_jet2.at(best_idijet).at(ivtx))
...
print(float(hasvtx)/float(nentries))
fout.WriteTObject(h_ntrk, "h_ntrk")
