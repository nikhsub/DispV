...
jet1_ptrkdR = array.array('d', max_Nptrk*[0])
...
newtree.Branch("jet1_ptrkdR", jet1_ptrkdR, "jet1_ptrkdR[nptrk_size]/D")
...
for iev in range(nentries):
    ...
    if best_idijet!=-1:
        ...
        for iptrk in range(Nptrk[0]):
            if promptIndices[iptrk]==1 and jet1_iptrk<max_Nptrk:
                ...
                jet1_ptrkdR[jet1_iptrk] = promptdRjet1[iptrk]-0.6
