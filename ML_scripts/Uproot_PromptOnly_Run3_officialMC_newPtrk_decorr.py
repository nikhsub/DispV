...
import CNNblock
from CNNblock import CNN_block, GNN_block, GNN_block_shallow, GNN_ptrk_block, GNN_ptrkslim_block
...
inputvars["ptrk_vars"] = ['ptrkPVidx', 'ptrkIP2D', 'ptrkIP2Dsig', 'ptrkIP3Dminsig', 'ptrkEFrac', 'ptrkjet1', 'ptrkjet2']
